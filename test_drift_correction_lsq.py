...
import sys
sys.path.insert(0, r"C:\Users\jj_ve\OneDrive - Delft University of Technology\Documents\Thesis Lunar Leaper\Code")
from drift_correction_lsq import assign_loops, assign_locations, solve_line

BASE = Path(r"C:\Users\jj_ve\OneDrive - Delft University of Technology\Documents\Thesis Lunar Leaper")
df = pd.read_csv(BASE / "Data/Gravimetry/station_means_drop5.csv",
