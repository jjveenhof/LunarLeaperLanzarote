...
- Legacy planning shapefiles in QGIS project/ (`All GPR surveys.shp`, ContextLine, FlowerPetalLine, CentreLines, etc.) -- planned/reference GPR lines from the planning stage; mostly superseded
