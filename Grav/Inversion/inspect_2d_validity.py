...
from grav_utils import G_NEWTON as G, RHO_DEFAULT as _RHO   # one definition of each
import invert_tube as _it                                   # paths via grav_utils
MGAL, RHO = 1e5, -_RHO * 1000.0
BASE, FIG = _it.BASE, _it.FIG
