...
# Styling + the three data helpers live in terrain_common so that the free-depth twin
# and freedepth.py can share them without importing a plotting SCRIPT. Re-exported here
# under their original names -- this module used to define them, and callers still say
# `pmt.STN_MARKER`.
from terrain_common import (                                        # noqa: F401
    CORR, WITHTC, GPR_GNSS,
    LINE_COLORS, STN_MARKER, STN_SIZE, FIT_LS, LIDAR_COLOR, PICK_C,
    PANEL_LETTERS, PANEL_LETTER_XY, PANEL_LETTER_KW,
    gravity_profile, posterior_envelope, gpr_surface,
)
