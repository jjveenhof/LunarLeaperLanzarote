...
-----
    ...
    Data/Gravimetry/Processed/lsq_drift_decay.csv        (our LSQ)
...
def main(rho=RHO_DEFAULT):
    ...
    f2   = PROC_DIR / f"bouguer_anomaly_decay_rho{rho_str(rho)}_with_TC.csv"
...
if __name__ == "__main__":
    main(float(sys.argv[1]) if len(sys.argv) > 1 else RHO_DEFAULT)
