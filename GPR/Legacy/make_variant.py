...
Ad-hoc tool, NOT part of the reproduce chain and not in the README.md file table.
It generated the L2/SVD-notch trial (the `Line5_100MHz_svd1_*` artifacts sit next
to it in this Legacy/ folder). Its conclusion -- the L2 100 MHz notch is a hardware
artifact that SVD/whitening do not fix -- is preserved in Code/GPR/README.md and
